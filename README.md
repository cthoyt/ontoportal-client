...
```console
$ uv pip install git+https://github.com/cthoyt/ontoportal-client.git
```

or with pip:

```console
$ python3 -m pip install git+https://github.com/cthoyt/ontoportal-client.git
```
...
appreciated. See
[CONTRIBUTING.md](https://github.com/cthoyt/ontoportal-client/blob/master/.github/CONTRIBUTING.md)
...
[GitHub Action](https://github.com/cthoyt/ontoportal-client/actions?query=workflow%3ATests).
...
https://zenodo.org/account/settings/github/repository/cthoyt/ontoportal-client
...
1. Navigate to https://github.com/cthoyt/ontoportal-client/releases/new to draft
   a new release
